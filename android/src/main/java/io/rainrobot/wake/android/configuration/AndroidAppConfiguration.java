...
import io.rainrobot.wake.android.alarm.AndroidSchedulerServiceServiceMgr;
import io.rainrobot.wake.android.client.springClient.SpringHttpRequestSenderConfiguration;
...
public class AndroidAppConfiguration extends AppConfiguration {
    ...
    public IHttpRequestSender getHttpSender() {
        return appContainer.getHttpSender(
                () -> new SpringHttpRequestSenderConfiguration()
                        .getRequestSender());
    }
    ...
    public ISchedulerServiceMgr getAlarmSchedulerMgr() {
        return appContainer.alarmSchedulerServiceMgr.get(() -> {
           return new AndroidSchedulerServiceServiceMgr(getContaxt());
        });
    }
