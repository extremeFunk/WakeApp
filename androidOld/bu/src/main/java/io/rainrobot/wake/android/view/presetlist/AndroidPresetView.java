...
public class AndroidPresetView extends AndroidView<PresetListActivity, PresetsController> implements PresetsView {
    ...
    @Override
    public void setDeleteCommand(IdCommand command) {
        adapter.setDeleteCommand(command);
    }
    @Override
    ...
    @Override
    public void setEditCommand(IdCommand command) {
        adapter.setEditCommand(command);
    }

    @Override
    public void setRenameCommand(PresetsController.NameCommand command) {
        adapter.setRenameCommand(command);
    }
    ...
    @Override
    public void setActiveStateCommand(PresetsController.ActiveStateCommand command) {
        adapter.setActivieStateCommand(command);
    }

    @Override
    public void setTimeCommand(PresetsController.TimeCommand command) {
        adapter.setTimeCommand(command);
    }
